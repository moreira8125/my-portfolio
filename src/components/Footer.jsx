...
function Footer() {
  ...
  const github = (
    <svg
      ...
      height="100"
      viewBox="0 0 30 30"
      className="w-6 h-6  lg:h-10 lg:w-10 fill-logo-blue"
    >
  ...
  return (
    <footer className="bg-logo-gold h-24 lg:h-36 flex justify-around items-center mt-auto ">
      <div className="flex flex-col gap-2 lg:gap-4">
        <div className="flex items-center relative">
          <p className="cursor-pointer flex items-center" onClick={openPhone}>
            ...
            >
              <a href="tel:+351 915 985 739" className="text-sm lg:text-lg">
                +351 915 985 739
              </a>
            </span>
          </p>
          ...
          <p className="cursor-pointer flex items-center" onClick={openEmail}>
            ...
            >
              <a
                ...
                href="mailto:dmoreira1999@hotmail.com"
              >
